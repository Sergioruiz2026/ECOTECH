...
- Analizar `ECOTECH` cuando exista. En el estado actual del repositorio, el archivo equivalente es `main.py`; usarlo como objetivo sin renombrarlo automáticamente.
